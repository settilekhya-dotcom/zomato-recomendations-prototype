...
class TestAPI(unittest.TestCase):
    """
    Unit tests for the Phase 6 FastAPI endpoints.
    """

    def test_root_endpoint(self):
        """Test the root entry point."""
        response = client.get("/")
    ...
    def test_recommend_endpoint_success(self, mock_recommender_class):
        """
        Test successful recommendation retrieval with mocked business logic.
        """
        # Set up mock
